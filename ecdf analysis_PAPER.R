...
################################
# Kruskal-wallis test for Arf1GFP distances from cell centre
...
################ Rab7DN Ecad vesicles distance from cell centre...PROOF OF PRINCIPLE
require(ggplot2)
...
setwd("~/Desktop/OneDrive - sheffield.ac.uk/#Transport Paper_wt_Gleb/#DATA/#Clustering_copy")
...
################################
# Kruskal-wallis test for Arf1GFP inter-organelle distances
library(PMCMR)

attach(dat)

kruskal.test(Norm_len ~ Genotype, data = dat)

posthoc.kruskal.dunn.test(x = Norm_len, g = Genotype, p.adjust.method = "BH")

#####################################################
##########  Stat Results for Arf1GFP inter-organelle distances #######
######################################################
...
library(FSA)
dunnTest(Norm_len ~ Genotype, data = dat, method = "bh")
...
# 1  Control - Dhc36583 -0.4124322 0.680022688 0.680022688
# 2  Control - Khc35770  2.9490796 0.003187219 0.009561656
# 3 Dhc36583 - Khc35770  2.9480240 0.003198122 0.004797183




##############################################################
# ECAD PUNCTA DISTANCES FROM THE CELL CENTRE ... 
